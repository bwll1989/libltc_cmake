 ...
 */
libltc_API void ltc_decoder_write_double(LTCDecoder *d, double *buf, size_t size, ltc_off_t posinfo);
 ...
 */
libltc_API void ltc_encoder_set_user_bits(LTCEncoder *e, unsigned long data);
 ...
 */
libltc_API unsigned long ltc_frame_get_user_bits(LTCFrame *f);
 ...
 */
libltc_API int ltc_encoder_get_buffer(LTCEncoder *e, ltcsnd_sample_t *buf) DEPRECATED_EXPORT;
 ...
 * pointed to by buf.
 */
libltc_API int ltc_encoder_copy_buffer(LTCEncoder *e, ltcsnd_sample_t *buf);
 ...
 */
libltc_API ltcsnd_sample_t *ltc_encoder_get_bufptr(LTCEncoder *e, int *size, int flush) DEPRECATED_EXPORT;
 ...
 */
libltc_API int ltc_encoder_get_bufferptr(LTCEncoder *e, ltcsnd_sample_t **buf, int flush);
 ...
 */
libltc_API int ltc_encoder_set_bufsize(LTCEncoder *e, double sample_rate, double fps) DEPRECATED_EXPORT;
 ...
 *   encoder unusable, call \ref ltc_encoder_free or realloc the buffer)
 */
libltc_API int ltc_encoder_set_buffersize(LTCEncoder *e, double sample_rate, double fps);
 ...
 */
libltc_API double ltc_encoder_get_volume(LTCEncoder *e);
 ...
 */
libltc_API double ltc_encoder_get_filter(LTCEncoder *e);
 ...
 * @param e encoder handle
 */
libltc_API void ltc_encoder_encode_reversed_frame(LTCEncoder *e);
 ...
 */
libltc_API int ltc_frame_parse_bcg_flags(LTCFrame *frame, enum LTC_TV_STANDARD standard);
